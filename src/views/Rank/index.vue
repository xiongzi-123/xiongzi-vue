<template>
  <div class="page-rank">
    ...
    <!-- <div class="rank_list_box">
      <div class="box" v-for="item in RankList" :key="item.comic_id">
        <div class="box-left">
    ...
    <!-- <div class="box">
        <div class="box-left">
          <img
            src="https://img.manhua.weibo.com/hcover/2018/09/12/2660188431_mY991vM7.png"
            alt=""
          />
        </div>
        <div class="box-center">
          <div class="center-top">水晶鞋</div>
          <div class="center-center">
            <img
              src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgBAMAAACBVGfHAAAAGFBMVEUAAABKkOJLkeNLkONVqv9LkuRMkeNKkOIsiLo4AAAAB3RSTlMA5rWIBktK5LpJhQAAADpJREFUKM9joBFgMSwXdkAWYC4vLzdgUAeSRRABxjKGcAFkAfYCEEIATAHGUoQWTEMR1hIGo74lEgAAomkhe7DLd3MAAAAASUVORK5CYII="
              alt=""
